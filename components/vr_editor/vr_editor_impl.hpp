...
build_port_handles(const VrPanel& card,
...
// Draw a bezier wire between two world positions.
...
std::optional<VrEditor::GraphEdit> VrEditor_update_drag(VrEditor& self, bool grip_right, const Graph*);
std::optional<VrEditor::GraphEdit> VrEditor_update_sliders(VrEditor& self, const XrPosef*, bool trigger_right, const Graph*);
std::optional<VrEditor::GraphEdit> VrEditor_update_dwell(VrEditor& self, const XrPosef*, float dt, const Graph*);
std::optional<VrEditor::GraphEdit> VrEditor_update_undo(VrEditor& self, const Eigen::Vector2f& thumb);
