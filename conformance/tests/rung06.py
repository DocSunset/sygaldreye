...
TESTS = {
    "sto.object_machinery.put_get_roundtrip": sto11_object_machinery,
    "sto.store_graph_face.no_ambient_store": sto21_store_graph_face,
    "sto.commit_paths.compile_recipe_memo": sto31_compile_is_committed_derivation,
    "sto.commit_paths.capture_testimony": sto32_capture_testimony,
    "sto.refs_and_undo.undo_ref_trail": sto41_refs_and_undo,
    "sto.provide_compatible.evict_refetch": sto51_provide_compatible,
    "sto.provide_compatible.provided_is_query": sto52_provisional_until_provided,
    "sto.fetch.resumable_fetch": sto61_resumable_fetch,
    "sto.composite_graphs.shared_topology": sto71_presets_share_topology,
    "sto.composite_graphs.orphan_conflict": sto72_orphaned_default_conflicts,
    "sto.retention_and_forgetting.forgetting_converges": sto81_forgetting_converges,
    "sto.back_link_index.index_is_derived": sto91_backlink_index_is_derived,
    "lng.query_vocabulary.lineage_query": lng101_lineage_query,
    "lng.query_vocabulary.standing_incremental": lng102_standing_query_incremental,
    "lng.query_vocabulary.fixpoint_terminates": lng103_fixpoint_terminates_on_cycles,
    "lng.query_vocabulary.palette_is_query": lng104_no_bespoke_search,
}
